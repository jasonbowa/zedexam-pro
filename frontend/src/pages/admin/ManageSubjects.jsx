...
export default function ManageSubjects() {
  ...
  const handleEdit = (subject) => {
    ...
    setGrade(String(subject.grade || "FORM_4").replace(/_/g, " "));
        ...
        <div style={mainGrid}>
          <section style={panelCard}>
            ...
            <form onSubmit={handleSubmit} style={formGrid}>
              ...
              <div>
                <label style={label}>Grade/Form</label>
                <select value={grade} onChange={(e) => setGrade(e.target.value)} style={input}>
                  {["FORM 1", "FORM 2", "FORM 3", "FORM 4", "GRADE 10", "GRADE 11", "GRADE 12"].map((item) => (
                    ...
                    <div style={subjectTop}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <p style={subjectDescription}>
                          {String(subject.grade || "").replace(/_/g, " ")} / {subject.description || "No description provided yet."}
                        </p>
                      </div>
                    </div>
